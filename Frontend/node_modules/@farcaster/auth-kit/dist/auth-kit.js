import { viemConnector as Ut, createAppClient as be } from "@farcaster/auth-client";
export * from "@farcaster/auth-client";
import { jsx as E, jsxs as T, Fragment as J } from "react/jsx-runtime";
import * as I from "react";
import { createContext as Be, useState as P, useEffect as Z, useCallback as R, useContext as Ie, useRef as Wt, useMemo as Ae } from "react";
...
function Te({
  ...
  const { config: c } = q(), { siweUri: s, domain: f } = c, l = lt(), [y, w] = P(!1), [d, g] = P(), [u, C] = P(), [h, p] = P(), [v, m] = P(!1), [S, B] = P(!1), [b, A] = P(), M = R(async () => {
    if (y && l && s && f && !d) {
      ...
      if (vt)
        ...
        g(tt), C(Zt), p(Dt), m(!0), o == null || o({ channelToken: tt, url: Zt, nonce: Dt });
      }
    }
  }, [
    y,
  ...
  const N = R(async () => {
    ...
    g(void 0), C(void 0), m(!1), B(!1), A(void 0);
  }, [g, C, m, B, A]), L = R(() => {
    k(), N();
  }, [N, k]);
  return {
...
function Re({
  ...
  const a = lt(), [c, s] = P(!1), [f, l] = P(!1), [y, w] = P(!1), [d, g] = P(), u = async () => {
...
function Le(t) {
  const e = lt(), { channelToken: n, timeout: r, interval: o, onSuccess: i, onError: a, onResponse: c } = {
    ...ke,
    ...t
  }, [s, f] = P(), [l, y] = P(!1), [w, d] = P(!1), [g, u] = P(!1), [C, h] = P(!1), [p, v] = P(), m = () => {
    f(void 0), y(!1), h(!1), d(!1), v(void 0);
  }, S = () => {
    y(!0);
  }, B = R(async () => {
    if (l && e && n) {
...
var De = "_1n3pr301", Ue = "_1n3pr305", Ve = "_1n3pr304", He = "_1n3pr300", Tt = "_1n3pr302", xe = "_1n3pr303";
function Gt({ kind: t = "primary", children: e, className: n, ...r }) {
  return /* @__PURE__ */ E("button", { type: "button", className: ze[t] || n, ...r, children: e });
}
const ze = {
  primary: De,
  secondary: Tt,
...
function Oe({
  ...
  return /* @__PURE__ */ T(Gt, { kind: "primary", onClick: e, disabled: n, children: [
    /* @__PURE__ */ E(Ze, { height: 20, fill: "white" }),
    /* @__PURE__ */ E("span", { style: { marginLeft: 9 }, children: t })
  ] });
}
function Ke(t, e) {
  Z(() => {
...
function qe({ signOut: t }) {
  return /* @__PURE__ */ E("div", { className: Je, children: /* @__PURE__ */ T(
    "button",
    {
      type: "button",
      className: Tt,
      ...
      children: [
        /* @__PURE__ */ T(
          "svg",
          {
            ...
            className: We,
            children: [
              /* @__PURE__ */ E("title", { children: "Sign Out" }),
              /* @__PURE__ */ E(
                "path",
                {
          ...
          children: [
            /* @__PURE__ */ T(
              "button",
              {
                ...
                onClick: () => o(!r),
                children: [
                  /* @__PURE__ */ E("img", { className: $e, src: c, alt: "avatar" }),
                  /* @__PURE__ */ E("span", { className: je, children: a }),
                  !n && /* @__PURE__ */ T(
                    "svg",
                    {
                      width: "24",
                      ...
                      xmlns: "http://www.w3.org/2000/svg",
                      children: [
                        /* @__PURE__ */ E("title", { children: "Dropdown" }),
                        /* @__PURE__ */ E("g", { opacity: "0.5", children: /* @__PURE__ */ E(
                          "path",
                          {
                            fillRule: "evenodd",
                            clipRule: "evenodd",
...
var x = Bt ? { passive: !1 } : !1, En = function(t) {
  ...
  var i = An(t, window.getComputedStyle(e).direction), a = i * r, c = n.target, s = e.contains(c), f = !1, l = a > 0, y = 0, w = 0;
  do {
  ...
  return (l && (o && Math.abs(y) < 1 || !o && a > y) || !l && (o && Math.abs(w) < 1 || !o && -a > w)) && (f = !0), f;
}, nt = function(t) {
...
function Rn(t) {
  ...
  I.useEffect(function() {
    ...
    if (t.inert) {
      ...
      var u = Ge([t.lockRef.current], (t.shards || []).map(zt), !0).filter(Boolean);
...
function Dn(t) {
  ...
  return Z(() => {
    ...
    /* @__PURE__ */ E(
      "div",
      {
        onFocus: R(() => e.current && Ot(e.current, "end"), []),
        tabIndex: 0
      }
    ),
    /* @__PURE__ */ E("div", { ref: e, style: { outline: "none" }, tabIndex: -1, ...t }),
    /* @__PURE__ */ E(
      "div",
      {
        onFocus: R(() => e.current && Ot(e.current, "start"), []),
        tabIndex: 0
      }
    )
  ] });
...
function On({ children: t, onClose: e, open: n, titleId: r }) {
  ...
  const a = R(() => e(), [e]);
  return /* @__PURE__ */ E(J, { children: n ? Me(
    /* @__PURE__ */ E(_n, { enabled: o, children: /* @__PURE__ */ E(
      "div",
      {
        style: {
...
var Kn = "_1sj0tk80", Kt = "_1sj0tk82", Yn = "_1sj0tk85", Yt = "_1sj0tk81", Q = {}, $n = function() {
...
const tr = new RegExp("^" + W + "$"), er = new RegExp("^" + me + "$"), nr = new RegExp("^[A-Z0-9 $%*+\\-./:]+$");
...
var ve = {};
const At = F, we = 1335, rr = 21522, jt = At.getBCHDigit(we);
...
const gt = F, Ct = ft, vr = Jn, wr = Wn, pr = le, yr = ue, Mt = fe, Nt = dt, Cr = Qn, st = ge, Er = ve, Sr = H, Et = pe;
function br(t, e) {
...
function Zr({ ecl: t = "M", size: e = 200, uri: n }) {
  ...
  return /* @__PURE__ */ T("div", { className: Ve, children: [
    ...
    /* @__PURE__ */ T("svg", { height: o, style: { all: "revert" }, width: o, children: [
      /* @__PURE__ */ E("title", { children: "QR Code" }),
      /* @__PURE__ */ E("rect", { fill: "transparent", height: o, width: o }),
      i
    ] })
  ] });
}
function Dr({
  ...
  return /* @__PURE__ */ E(On, { open: t, titleId: "Sign in with Farcaster", onClose: e, children: /* @__PURE__ */ E("div", { className: "fc-authkit-qrcode-dialog", children: /* @__PURE__ */ E("div", { className: Kn, children: r ? /* @__PURE__ */ T(J, { children: [
    /* @__PURE__ */ E("div", { className: Yt, children: "Error" }),
    /* @__PURE__ */ E("div", { className: Kt, children: (o == null ? void 0 : o.message) ?? "Unknown error, please try again." })
  ] }) : /* @__PURE__ */ T(J, { children: [
    /* @__PURE__ */ E("div", { className: Yt, children: "Sign in with Farcaster" }),
    /* @__PURE__ */ E("div", { className: Kt, children: "To sign in with Farcaster, scan the code below with your phone's camera." }),
    /* @__PURE__ */ E("div", { className: Yn, children: /* @__PURE__ */ E(Zr, { uri: n, size: 200 }) }),
    /* @__PURE__ */ E("div", { style: { display: "flex", justifyContent: "center" }, children: /* @__PURE__ */ T(
      Gt,
      {
        kind: "tertiary",
        style: {
        ...
        children: [
          /* @__PURE__ */ T(
            "svg",
            {
              ...
              fill: "none",
              children: [
                /* @__PURE__ */ E("title", { children: "Sign in With Farcaster QR Code" }),
                /* @__PURE__ */ E(
                  "path",
                  {
                    fill: "#7C65C1",
          ...
          /* @__PURE__ */ E("span", { style: { marginLeft: 9 }, children: "I'm using my phone →" })
        ]
      }
    ) })
  ] }) }) }) });
...
function Vr({
  ...
  const { onSuccess: o, onStatusResponse: i, onError: a } = r, c = R(
    ...
    h && u(), M(!0), w(), m && It() && (window.location.href = m);
  }, [h, u, w, m]), k = C && B;
  return Z(() => {
    v || g();
    ...
    k ? /* @__PURE__ */ E(
      ...
      /* @__PURE__ */ E(Oe, { initializing: !m, onClick: N, label: "Sign in" }),
      m && /* @__PURE__ */ E(
        Dr,
        {
          open: A && !It(),
    ...
    t && /* @__PURE__ */ E("div", { className: Ur, children: /* @__PURE__ */ E("pre", { children: JSON.stringify(y, null, 2) }) })
  ] });
}
function Hr() {
...
function $r() {
  return /* @__PURE__ */ T(Pe, { config: {
    ...
    /* @__PURE__ */ E("div", { style: { position: "fixed", top: 12, right: 12, zIndex: 1e3 }, children: /* @__PURE__ */ E(
      Vr,
      {
        nonce: "abcd1234",
...
function xr() {
  ...
  return /* @__PURE__ */ E("div", { style: { fontFamily: "sans-serif" }, children: t && /* @__PURE__ */ T("div", { children: [
    e && /* @__PURE__ */ T("p", { children: [
      /* @__PURE__ */ E("strong", { children: "FID:" }),
      " ",
      e
    ] }),
    r && /* @__PURE__ */ T("p", { children: [
      /* @__PURE__ */ E("strong", { children: "Display name:" }),
      " ",
      r
    ] }),
    n && /* @__PURE__ */ T("p", { children: [
      /* @__PURE__ */ E("strong", { children: "Bio:" }),
      " ",
      n
    ] }),
    o && /* @__PURE__ */ T("p", { children: [
      /* @__PURE__ */ E("strong", { children: "Custody address:" }),
      " ",
      o
    ] })
  ] }) });
