import { viemConnector as Vt, createAppClient as Be } from "@farcaster/auth-client";
export * from "@farcaster/auth-client";
import { jsx as p, jsxs as M, Fragment as j } from "react/jsx-runtime";
import * as I from "react";
import { createContext as Ie, useState as T, useEffect as Z, useCallback as R, useContext as Ae, useRef as qt, useMemo as Me } from "react";
import { createPortal as Ne } from "react-dom";
const Pe = typeof window < "u" && (window != null && window.location) ? {
...
function Te({
  ...
  const [n, r] = T(), [o, i] = T(!1), [a, c] = T({}), [s, f] = T({}), l = {
    ...Qt,
    ...t
  }, { relay: S, rpcUrl: h, version: v, provider: y } = l;
  Z(() => {
    const g = h ? Vt({ rpcUrl: h }) : Vt(), w = Be({
      relay: S,
      ethereum: g,
      version: v
    }, y);
  ...
  const u = R((g) => {
    ...
    i(!0), c({ fid: d, username: C, bio: B, displayName: b, pfpUrl: A, custody: N, verifications: P }), f({ message: w, signature: m });
  }, []), E = () => {
    i(!1), c({}), f({});
  };
  return /* @__PURE__ */ p(
...
function Re({
  ...
  const { config: c } = q(), { siweUri: s, domain: f } = c, l = lt(), [S, h] = T(!1), [v, y] = T(), [u, E] = T(), [g, w] = T(), [m, d] = T(!1), [C, B] = T(!1), [b, A] = T(), N = R(async () => {
    if (S && l && s && f && !v) {
      ...
      if (vt)
        ...
        y(tt), E(Dt), w(Ut), d(!0), o == null || o({ channelToken: tt, url: Dt, nonce: Ut });
      }
    }
  }, [
    S,
  ...
  const P = R(async () => {
    ...
    y(void 0), E(void 0), d(!1), B(!1), A(void 0);
  }, [y, E, d, B, A]), L = R(() => {
    k(), P();
  }, [P, k]);
  return {
...
function ke({
  ...
  const a = lt(), [c, s] = T(!1), [f, l] = T(!1), [S, h] = T(!1), [v, y] = T(), u = async () => {
    h(!1), l(!1), s(!1), y(void 0);
  }, E = R(async () => {
    if (a && t && e && n && r) {
      const {
        success: g,
      ...
      w ? (h(!0), y(m), i == null || i(m)) : (s(g), l(!0), o == null || o({ message: n, signature: r, validSignature: g }));
    }
  }, [a, t, e, n, r, o, i]);
  return Z(() => {
    u(), t && e && n && r && E();
...
function _e(t) {
  const e = lt(), { channelToken: n, timeout: r, interval: o, onSuccess: i, onError: a, onResponse: c } = {
    ...Le,
    ...t
  }, [s, f] = T(), [l, S] = T(!1), [h, v] = T(!1), [y, u] = T(!1), [E, g] = T(!1), [w, m] = T(), d = () => {
    f(void 0), S(!1), g(!1), v(!1), m(void 0);
  }, C = () => {
    S(!0);
  }, B = R(async () => {
    if (l && e && n) {
      ...
      A ? (g(!0), u(!1), m(N), a == null || a(N)) : (v(!0), u(!1), f(b), i == null || i(b));
    }
  }, [l, e, n, r, o, i, a, c]);
  return Z(() => {
    d(), n && B();
...
function Ze(t) {
  ...
  } = q(), { timeout: a, interval: c, onSuccess: s, onStatusResponse: f, onError: l, ...S } = {
    ...Fe,
    ...t
  }, {
    connect: h,
...
var De = "_1n3pr301", Ue = "_1n3pr306", Ve = "_1n3pr304", He = "_1n3pr305", xe = "_1n3pr300", Rt = "_1n3pr302", Oe = "_1n3pr303";
function Bt({ kind: t = "primary", children: e, className: n, ...r }) {
  return /* @__PURE__ */ p("button", { type: "button", className: ze[t] || n, ...r, children: e });
}
const ze = {
  primary: De,
  secondary: Rt,
...
function Ke({
  ...
  return /* @__PURE__ */ M(Bt, { kind: "primary", onClick: e, children: [
    /* @__PURE__ */ p(Xt, { height: 20, fill: "white" }),
    /* @__PURE__ */ p("span", { style: { marginLeft: 9 }, children: t })
  ] });
}
function Ye(t, e) {
  Z(() => {
...
var $e = "_1rbg3ua1", We = "_1rbg3ua2", je = "_1rbg3ua3", Je = "_16wbil70", qe = "_16wbil71";
function Qe({ signOut: t }) {
  return /* @__PURE__ */ p("div", { className: Je, children: /* @__PURE__ */ M(
    "button",
    {
      type: "button",
      className: Rt,
      ...
      children: [
        /* @__PURE__ */ M(
          "svg",
          {
            ...
            className: qe,
            children: [
              /* @__PURE__ */ p("title", { children: "Sign Out" }),
              /* @__PURE__ */ p(
                "path",
                {
          ...
          children: [
            /* @__PURE__ */ M(
              "button",
              {
                ...
                onClick: () => o(!r),
                children: [
                  /* @__PURE__ */ p("img", { className: We, src: c, alt: "avatar" }),
                  /* @__PURE__ */ p("span", { className: je, children: a }),
                  !n && /* @__PURE__ */ M(
                    "svg",
                    {
                      width: "24",
                      ...
                      xmlns: "http://www.w3.org/2000/svg",
                      children: [
                        /* @__PURE__ */ p("title", { children: "Dropdown" }),
                        /* @__PURE__ */ p("g", { opacity: "0.5", children: /* @__PURE__ */ p(
                          "path",
                          {
                            fillRule: "evenodd",
                            clipRule: "evenodd",
...
var it = "right-scroll-bar-position", at = "width-before-scroll-bar", tn = "with-scroll-bars-hidden", en = "--removed-body-scroll-bar-size";
function nn(t, e) {
...
var ne = sn(), wt = function() {
}, ut = I.forwardRef(function(t, e) {
  var n = I.useRef(null), r = I.useState({
    onScrollCapture: wt,
    onWheelCapture: wt,
    onTouchMoveCapture: wt
  }), o = r[0], i = r[1], a = t.forwardProps, c = t.children, s = t.className, f = t.removeScrollBar, l = t.enabled, S = t.shards, h = t.sideCar, v = t.noIsolation, y = t.inert, u = t.allowPinchZoom, E = t.as, g = E === void 0 ? "div" : E, w = t.gapMode, m = te(t, ["forwardProps", "children", "className", "removeScrollBar", "enabled", "shards", "sideCar", "noIsolation", "inert", "allowPinchZoom", "as", "gapMode"]), d = h, C = on([n, e]), B = D(D({}, m), o);
  return I.createElement(
    I.Fragment,
    null,
    l && I.createElement(d, { sideCar: ne, removeScrollBar: f, shards: S, noIsolation: v, inert: y, setCallbacks: i, allowPinchZoom: !!u, lockRef: n, gapMode: w }),
...
var x = It ? { passive: !1 } : !1, Sn = function(t) {
...
}, Nn = function(t, e, n, r, o) {
  var i = Mn(t, window.getComputedStyle(e).direction), a = i * r, c = n.target, s = e.contains(c), f = !1, l = a > 0, S = 0, h = 0;
  do {
  ...
  return (l && (o && Math.abs(S) < 1 || !o && a > S) || !l && (o && Math.abs(h) < 1 || !o && -a > h)) && (f = !0), f;
}, nt = function(t) {
...
function kn(t) {
  ...
  I.useEffect(function() {
    ...
    if (t.inert) {
      ...
      var u = Xe([t.lockRef.current], (t.shards || []).map(zt), !0).filter(Boolean);
  ...
  var c = I.useCallback(function(u, E) {
  ...
  }, []), f = I.useCallback(function(u, E, g, w) {
    ...
    f(u.type, Ot(u), u.target, c(u, t.lockRef.current));
...
function Un(t) {
  ...
  return Z(() => {
    ...
    /* @__PURE__ */ p(
      "div",
      {
        onFocus: R(() => e.current && Kt(e.current, "end"), []),
        tabIndex: 0
      }
    ),
    /* @__PURE__ */ p("div", { ref: e, style: { outline: "none" }, tabIndex: -1, ...t }),
    /* @__PURE__ */ p(
      "div",
      {
        onFocus: R(() => e.current && Kt(e.current, "start"), []),
        tabIndex: 0
      }
    )
  ] });
...
function Kn({ children: t, onClose: e, open: n, titleId: r }) {
  ...
  const a = R(() => e(), [e]);
  return /* @__PURE__ */ p(j, { children: n ? Ne(
    /* @__PURE__ */ p(Fn, { enabled: o, children: /* @__PURE__ */ p(
      "div",
      {
        style: {
...
var Yn = "_1sj0tk80", $n = "_1sj0tk84", Yt = "_1sj0tk82", Wn = "_1sj0tk83", $t = "_1sj0tk81", Q = {}, jn = function() {
...
(function(t) {
  ...
  t.isValid = function(o) {
    ...
    for (let S = 0; S < i; S++) {
      ...
      for (let h = 0; h < i; h++) {
        let v = o.get(S, h);
        v === f ? c++ : (c >= 5 && (a += e.N1 + (c - 5)), f = v, c = 1), v = o.get(h, S), v === l ? s++ : (s >= 5 && (a += e.N1 + (s - 5)), l = v, s = 1);
      }
...
var he = {}, ht = {};
const W = new Uint8Array(512), ct = new Uint8Array(256);
(function() {
  let e = 1;
  for (let n = 0; n < 255; n++)
...
const nr = new RegExp("^" + J + "$"), rr = new RegExp("^" + ve + "$"), or = new RegExp("^[A-Z0-9 $%*+\\-./:]+$");
...
var we = {};
const Mt = F, pe = 1335, ir = 21522, jt = Mt.getBCHDigit(pe);
...
(function(t) {
  var e = {
    single_source_shortest_paths: function(n, r, o) {
      ...
      c.push(r, 0);
      for (var s, f, l, S, h, v, y, u, E; !c.empty(); ) {
        s = c.pop(), f = s.value, S = s.cost, h = n[f] || {};
        for (l in h)
          h.hasOwnProperty(l) && (v = h[l], y = S + v, u = a[l], E = typeof a[l] > "u", (E || u > y) && (a[l] = y, c.push(l, y), i[l] = f));
      }
    ...
    for (let m = 0; m < g.length; m++) {
      ...
      switch (d.mode) {
        ...
        case e.KANJI:
          w.push([
            d,
            { data: d.data, mode: e.BYTE, length: f(d.data) }
          ]);
          break;
        case e.BYTE:
          w.push([
...
const gt = F, Ct = ft, pr = qn, yr = Qn, Cr = ue, Er = fe, Nt = de, Pt = dt, Sr = Xn, st = me, br = we, Br = H, Et = ye;
function Ir(t, e) {
...
function Rr(t, e, n) {
  const r = gt.getSymbolTotalCodewords(e), o = Pt.getTotalCodewordsCount(e, n), i = r - o, a = Pt.getBlocksCount(e, n), c = r % a, s = a - c, f = Math.floor(r / a), l = Math.floor(i / a), S = l + 1, h = f - l, v = new Sr(h);
  let y = 0;
...
(function(t) {
  ...
  t.getOptions = function(r) {
    ...
    const a = o.modules.size, c = o.modules.data, s = t.getScale(a, i), f = Math.floor((a + i.margin * 2) * s), l = i.margin * s, S = [i.color.light, i.color.dark];
    for (let h = 0; h < f; h++)
      for (let v = 0; v < f; v++) {
        let y = (h * f + v) * 4, u = i.color.light;
        if (h >= l && v >= l && h < f - l && v < f - l) {
...
(function(t) {
  ...
  t.render = function(i, a, c) {
    ...
    const l = e.getImageWidth(i.modules.size, s), S = f.getContext("2d"), h = S.createImageData(l, l);
    return e.qrToImageData(h.data, i, s), n(S, f, l), S.putImageData(h, 0, 0), f;
  }, t.renderToDataURL = function(i, a, c) {
    let s = c;
    typeof s > "u" && (!a || !a.getContext) && (s = a, a = void 0), s || (s = {});
    const f = t.render(i, a, s), l = s.type || "image/png", S = s.rendererOpts || {};
    return f.toDataURL(l, S.quality);
  };
})(Ee);
var Se = {};
const Lr = Ft;
...
Se.render = function(e, n, r) {
  const o = Lr.getOptions(n), i = e.modules.size, a = e.modules.data, c = i + o.margin * 2, s = o.color.light.a ? "<path " + Jt(o.color.light, "fill") + ' d="M0 0h' + c + "v" + c + 'H0z"/>' : "", f = "<path " + Jt(o.color.dark, "stroke") + ' d="' + _r(a, i, o.margin) + '"/>', l = 'viewBox="0 0 ' + c + " " + c + '"', h = '<svg xmlns="http://www.w3.org/2000/svg" ' + (o.width ? 'width="' + o.width + '" height="' + o.width + '" ' : "") + l + ' shape-rendering="crispEdges">' + s + f + `</svg>
`;
  return typeof r == "function" && r(null, h), h;
};
const Fr = jn, Tt = se, be = Ee, Zr = Se;
...
function Ur({
  ...
  const a = r - parseInt("20", 10) * 2, c = Me(() => {
  ...
  }, [t, n, e, a, o]), s = a / 2 - n / 2, f = n + e * 2;
  return /* @__PURE__ */ p("div", { className: Ve, children: /* @__PURE__ */ M("div", { className: He, children: [
    /* @__PURE__ */ p(
      "div",
      {
        className: Ue,
        ...
        children: /* @__PURE__ */ p(Xt, { fill: "purple", height: n })
      }
    ),
    /* @__PURE__ */ M("svg", { height: a, style: { all: "revert" }, width: a, children: [
      /* @__PURE__ */ p("title", { children: "QR Code" }),
      /* @__PURE__ */ M("defs", { children: [
        /* @__PURE__ */ p("clipPath", { id: "clip-wrapper", children: /* @__PURE__ */ p("rect", { height: f, width: f }) }),
        /* @__PURE__ */ p("clipPath", { id: "clip-logo", children: /* @__PURE__ */ p("rect", { height: n, width: n }) })
      ] }),
      /* @__PURE__ */ p("rect", { fill: "transparent", height: a, width: a }),
      c
    ] })
  ] }) });
}
function Vr({
  ...
  return /* @__PURE__ */ p(Kn, { open: t, titleId: "Sign In With Farcaster", onClose: e, children: /* @__PURE__ */ p("div", { className: "fc-authkit-qrcode-dialog", children: /* @__PURE__ */ M("div", { className: Yn, children: [
    /* @__PURE__ */ p(
      Bt,
      {
        kind: "reset",
        ...
        children: /* @__PURE__ */ M(
          "svg",
          {
            ...
            fill: "none",
            children: [
              /* @__PURE__ */ p("title", { children: "Sign in With Farcaster" }),
              /* @__PURE__ */ p(
                "path",
                {
                  fill: "rgba(0,0,0,0.5)",
    ...
    r ? /* @__PURE__ */ M(j, { children: [
      /* @__PURE__ */ p("div", { className: $t, children: "Error" }),
      /* @__PURE__ */ p("div", { className: Yt, children: (o == null ? void 0 : o.message) ?? "Unknown error, please try again." })
    ] }) : /* @__PURE__ */ M(j, { children: [
      /* @__PURE__ */ p("div", { className: $t, children: "Sign in with Farcaster" }),
      /* @__PURE__ */ p("div", { className: Yt, children: "Scan with your phone's camera to continue." }),
      /* @__PURE__ */ p("div", { className: $n, children: /* @__PURE__ */ p("a", { className: Wn, href: "https://warpcast.com/~/signup", target: "_blank", rel: "noreferrer", children: "Need to create an account?" }) }),
      /* @__PURE__ */ p(
        "div",
        {
          style: {
          ...
          children: /* @__PURE__ */ p(Ur, { uri: n, size: 300, logoSize: 28, logoMargin: 16 })
        }
      ),
      /* @__PURE__ */ p("div", { style: { display: "flex", justifyContent: "center" }, children: /* @__PURE__ */ M(
        Bt,
        {
          kind: "tertiary",
          style: {
          ...
          children: [
            /* @__PURE__ */ M(
              "svg",
              {
                ...
                fill: "none",
                children: [
                  /* @__PURE__ */ p("title", { children: "Sign in With Farcaster QR Code" }),
                  /* @__PURE__ */ p(
                    "path",
                    {
                      fill: "#7C65C1",
            ...
            /* @__PURE__ */ p("span", { style: { marginLeft: 9 }, children: "I'm using my phone →" })
          ]
        }
      ) })
    ] })
...
function xr({
  ...
  const { onSuccess: o, onStatusResponse: i, onError: a } = r, c = R(
    ...
    g && u(), N(!0), h(), d && At() && (window.location.href = d);
  }, [g, u, h, d]), k = E && B;
  return Z(() => {
    m || y();
  }, [m, y]), /* @__PURE__ */ M("div", { className: "fc-authkit-signin-button", children: [
    k ? /* @__PURE__ */ p(
      Ge,
      {
        userData: C,
      ...
      /* @__PURE__ */ p(Ke, { onClick: P, label: "Sign in" }),
      d && /* @__PURE__ */ p(
        Vr,
        {
          open: A && !At(),
    ...
    t && /* @__PURE__ */ p("div", { className: Hr, children: /* @__PURE__ */ p("pre", { children: JSON.stringify(S, null, 2) }) })
  ] });
}
function Or() {
...
function jr() {
  return /* @__PURE__ */ M(Te, { config: {
    rpcUrl: "https://mainnet.optimism.io"
  }, children: [
    /* @__PURE__ */ p("div", { style: { position: "fixed", top: 12, right: 12, zIndex: 1e3 }, children: /* @__PURE__ */ p(
      xr,
      {
        nonce: "abcd1234",
...
function zr() {
  ...
  return /* @__PURE__ */ p("div", { style: { fontFamily: "sans-serif" }, children: t && /* @__PURE__ */ M("div", { children: [
    e && /* @__PURE__ */ M("p", { children: [
      /* @__PURE__ */ p("strong", { children: "FID:" }),
      " ",
      e
    ] }),
    r && /* @__PURE__ */ M("p", { children: [
      /* @__PURE__ */ p("strong", { children: "Display name:" }),
      " ",
      r
    ] }),
    n && /* @__PURE__ */ M("p", { children: [
      /* @__PURE__ */ p("strong", { children: "Bio:" }),
      " ",
      n
    ] }),
    o && /* @__PURE__ */ M("p", { children: [
      /* @__PURE__ */ p("strong", { children: "Custody address:" }),
      " ",
      o
    ] })
  ] }) });
